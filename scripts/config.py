...
# --- ChatGPT image gen (OpenAI-compatible /v1/images/generations) ---
CHATGPT_API_URL = os.getenv("CHATGPT_API_URL", "http://localhost:20128/v1/images/generations")
CHATGPT_MODEL = os.getenv("CHATGPT_MODEL", "cx/gpt-5.4-image")
CHATGPT_QUALITY = os.getenv("CHATGPT_QUALITY", "auto")
CHATGPT_POLL_TIMEOUT = 600  # SSE streams can run long for high-detail images
# aspect_ratio -> pixel size accepted by the endpoint
CHATGPT_SIZES = {
    "1:1": "1024x1024",
    "3:4": "1024x1536",
    "9:16": "1024x1536",
