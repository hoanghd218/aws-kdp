...
MIN_SPINE_FOR_TEXT_IN = 0.125 # informational: physical spine must be at least this wide
MIN_PAGES_FOR_SPINE_TEXT = 79 # KDP rule: spine text is only allowed at 79+ pages
...
def full_cover_dims(page_size: str, page_count: int, paper: str = "white") -> dict:
    ...
    return {
        ...
        # KDP gates spine text on PAGE COUNT (79+), not spine width — a 56-78 page
        # book can have a wide-enough spine yet still be rejected for spine text.
        "spine_can_have_text": page_count >= MIN_PAGES_FOR_SPINE_TEXT,
    }
